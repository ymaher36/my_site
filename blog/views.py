...
posts = [
    {
        "slug": 'the-mountains',
        "image": 'mountains.jpg',
        "author": "Youssef ElZawawy",
        "date": date(2020, 9, 8),
        "title": "Mountain Hiking",
        "excerpt": """There's nothing I have ever seen is alike the views 
            you get after a journey of hiking to the mountain top!!""",
        "content": """
...
def index(request):
    sorted_posts = sorted(posts, key=get_post_date)
